     ...
     <div class="row no-gutters">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-0 filter-ticket">
                    <div class="d-flex justify-content-between filter">
                        <button class="btn btn-primary active" type="button" data-toggle="collapse" data-target="#disponivel" aria-expanded="false" aria-controls="disponivel"><span>Disponível</span></button>
                        <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#raspados" aria-expanded="false" aria-controls="raspados"><span>Raspados</span></button>
                        <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#premiados" aria-expanded="false" aria-controls="premiados"><span>Premiados</span></button>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div class="row no-gutters content-filter list-box">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 pt-4 box-bilhete">

                            <div class="collapse px-3 show" id="disponivel">
                            ...
                            <div class="collapse px-3" id="raspados">
                                ...
                                <asp:repeater id="Repeater2" runat="server" >
                                    <ItemTemplate>
                                        <div class="card mb-3 text-white" style="background-image: url(assets/image/bg-card-raspado.png);">
                                            <a href="scratched.aspx?cupId=<%# Container.DataItem("cup_id") %>">
                                                <div class="row no-gutters">
                                                    <div class="col-4 d-flex justify-content-center align-items-center">
                                                        <img src="assets/image/logo-Raspe&Ganhe.svg" alt="Raspe & Ganhe" class="w-75">
                                                    </div>
                            ...
                            <div class="collapse px-3" id="premiados">
                                                ...
                                                <div class="row no-gutters">
                                                    ...
                                                    <div class="col-8 text-right">
                                                        <div class="card-body">
                                                            ...
                                                            <h5>Voucher: <%# Container.DataItem("cal_voucher") %></h5>
