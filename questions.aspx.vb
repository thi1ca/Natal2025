Public Class questions
    ...
    Private Sub carregaPerguntas()
        Try
            'Ordem das perguntas:
            '1 - Loja
            'Second falhar primeira, tenta mais uma vez
            '2 - Data
            ...
            ElseIf dv.Count = 1 Then
                ...
                If dv(0)("res_acerto") = True Then
                    Response.Redirect("register.aspx")
                Else
                    'Se errou pergunta 1, tenta segunda pergunta
                    montaPergunta2()
                End If
            ElseIf dv.Count = 2 Then
                'Verifica se teve 1 pergunta certa
                ...
                End If
            ElseIf dv.Count > 2 Then
                'Se tiver + de 2 respostas, temos um problema
                'Dispara whatsapp para admin
                whatsapp.mensagem("5511987040377", "Raspadinha - O CPF " & CPF & " respondeu mais do que 2x as perguntas de validação.", 0)
    ...
    Private Sub montaPergunta2()
        Try
            ...
            tbCorreto.Text = cupomData.Date.ToString
