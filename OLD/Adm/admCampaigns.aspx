<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Adm/admLogado.Master" CodeBehind="admCampaigns.aspx.vb" Inherits="Torra.admCampaigns" %>
    ...
    <main role="main" class="container mb-5">
        <section  class="mb-3 mb-md-5">
            <div class="row mt-3 mt-md-5 align-items-center">
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 text-right text-sm-right text-md-right text-lg-right text-xl-right fixed-mobile">
                    ...
                    <asp:Button ID="butNew" runat="server" Text="+ Criar Campanha" class="btn bt-blue text-uppercase" role="button"/>
                ...
                <div class="row no-gutters">
                    <div class="col-12 form-group">
                       ...
                       <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 pl-0 pl-md-2 form-group">
                        <span class="has-float-label">
                             <div class="input-group select-mist mb-4">
                           <label for="DataInicio" class="floatlabel">Data de início</label>
                             <asp:TextBox ID="tbDataInicio" runat="server" class="form-control" placeholder="Data" MaxLength="12" TextMode="Date"></asp:TextBox>	
                                 </div>
                        </span>
                    </div>
                    <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 pl-0 pl-md-2 form-group">
                        <span class="has-float-label">
                            <div class="input-group select-mist mb-4">
                                <label for="DataFim" class="floatlabel">Data final</label>
                             <asp:TextBox ID="tbDataFinal" runat="server" class="form-control" placeholder="Data" MaxLength="12" TextMode="Date"></asp:TextBox>	
                                </div>
                            </div>
                 ...
                 <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 pl-0 pl-md-2 form-group">
                        <span class="has-float-label">
                            <div class="input-group select-mist mb-4">
                                <label for="DataPrazo" class="floatlabel">Data Limite para raspar</label>
                             <asp:TextBox ID="tbLimite" runat="server" class="form-control" placeholder="Data" MaxLength="12" TextMode="Date"></asp:TextBox>	
                                </div>
                            </div>
                        </span>
                    </div>
        ...
        <section class="show-list">
            ...
            <div class="card rounded-5 mb-3 w-100 my-2">
                <div class="row no-gutters <%# FunctionFundo(Container.DataItem("cam_ativo")) %>">
                    ...
                    <div class="col-12 col-sm-12 col-md-8 col-lg-7 col-lx-8 pl-0 pl-md-3">
                        <div class="card-body pt-0 pb-3 px-3 py-md-4 px-md-4">
                            ...
                            <p class="card-text"><%# Convert.ToDateTime(Container.DataItem("cam_inicio")).ToString("dd/MM/yyyy") %> - <%# Convert.ToDateTime(Container.DataItem("cam_fim")).ToString("dd/MM/yyyy") %></p>
                            <div class="d-flex">
                    ...
                    <div class="col-12 col-sm-12 col-md-2 col-lg-3 col-lx-2 py-1 px-3 p-md-4 text-left text-md-right order-first order-md-3">
                        ...
                        <div class="dropdown dropleft">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              ...
                              <a class="dropdown-item" href="admprizes.aspx?camId=<%# Container.DataItem("cam_id") %>">Prêmios</a>
