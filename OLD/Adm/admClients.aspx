<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Adm/admLogado.Master" CodeBehind="admClients.aspx.vb" Inherits="Torra.admClients" %>
    ...
    <main role="main" class="container mb-5">
        <section  class="mb-3 mb-md-5">
            <div class="row mt-3 mt-md-5 align-items-center">
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 text-right text-sm-right text-md-right text-lg-right text-xl-right fixed-mobile">
                    ...
                    <a class="btn bt-blue text-uppercase" href="admClients_edit.aspx" role="button">+ Criar Cliente</a>
                </div>
        ...
        <section class="show-list user">
            ...
            <div class="card rounded-5 mb-3 w-100 my-2">
                <div class="row no-gutters <%# funcFundo(Container.DataItem("cli_ativo")) %>">
                    ...
                    <div class="col-12 col-sm-12 col-md-8 col-lg-7 col-lx-8 pl-0 pl-md-3">
                        <div class="card-body pt-0 pb-3 px-3 py-md-4 px-md-4">
                            ...
                            <div class="d-flex">
                                <p class="card-text mr-3 mr-md-5 mb-0"><strong>Nasc:</strong><small class="text-muted d-block d-md-inline"> <%# Container.DataItem("cli_nascimento") %></small></p>
                                <p class="card-text mr-3 mr-md-5 mb-0"><strong>Celular:</strong><small class="text-muted  d-block d-md-inline"> <%# funcCel(Container.DataItem("cli_celular")) %></small></p>
                                <p class="card-text mr-3 mr-md-5 mb-0"><strong>Status:</strong><small class="text-muted  d-block d-md-inline"> <%# funcAtivo(Container.DataItem("cli_ativo")) %></small></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-2 col-lg-3 col-lx-2 py-1 px-3 p-md-4 text-left text-md-right order-first order-md-3">
                        <h6 class="mt-2 mt-md-1">ID: 000<%# Container.DataItem("cli_id") %></h6>
