...
#Region "FORMULARIO"
    ...
    Private Sub butCadastrar_Click(sender As Object, e As EventArgs) Handles butCadastrar.Click
        Try
            ...
            campo.Add("pre_nome")
            conteudo.Add(tbNome.Text)

            campo.Add("pre_voucher_codigo")
            conteudo.Add(tbVoucher.Text)

            campo.Add("pre_voucher")
            If cbVoucher.Checked = True Then
                conteudo.Add("1")
            Else
                conteudo.Add("0")
            End If
...
#Region "GRID"
    ...
    Public Sub CarregaGrid()
        Try
            ...
            sql = "select p.*, cam_nome, cad_nome from premio p inner join campanha c on p.cam_id = c.cam_id  "
            sql += " inner join cadastro ca on p.cad_id = ca.cad_id  "


            'Se tiver filtro no campo Nome
            If tbNomeFiltro.Text.Trim <> "" Then
                sql += " where pre_nome like '%" & tbNomeFiltro.Text.Trim & "%' "
            End If
    ...
    Private Sub Repeater1_ItemCommand(source As Object, e As RepeaterCommandEventArgs) Handles Repeater1.ItemCommand
        Try
            ...
            ElseIf e.CommandName = "Editar" Then
                ...
                tbNome.Text = dv(0)("pre_nome")
                tbVoucher.Text = dv(0)("pre_voucher_codigo")
                cbVoucher.Checked = dv(0)("pre_voucher")
