<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="questions.aspx.vb" MasterPageFile="~/semMenu.Master"  Inherits="Torra.questions" %>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                       ...
                       <div class="mb-3 d-flex flex-column flex-md-row flex-column-reverse">
                         <div class="custom-control custom-radio custom-control-inline form-check input-group-lg w-100 mb-3">
