Public Class accessCode
    ...
    Private Sub carregaOpcoes()
        Try
            Dim dv As DataView = banco.consulta("select cli_id, cli_nome, cli_email, cli_celular, cli_ativo from cliente where cli_cpf = '" & CPF & "'")
            If dv.Count = 0 Then
                Response.Redirect("index.aspx")
            ElseIf dv(0)("cli_ativo") = False Then
                whatsapp.mensagem("5511987040377", "Cliente do CPF " & CPF & " tentou se logar mas ele está desativado na raspadinha Torra")
    ...
    Private Sub enviaWhatsapp()
        Try
            ...
            Dim mensagem As String = "Código *" & codigoAcesso(1, CPF) & "* para acessar o Raspe & Ganhe. Para sua segurança, não o compartilhe."
