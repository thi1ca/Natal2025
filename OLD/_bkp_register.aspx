<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/semMenu.Master" CodeBehind="_bkp_register.aspx.vb" Inherits="Torra._bkp_register" %>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group">
                        <span class="has-float-label mb-2 in-phones">
                            <label for="phones" class="floatlabel color3">Telefone</label>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2 form-group input-senha">
                        <span class="has-float-label mb-2 in-senha">
                            ...
                            <asp:TextBox ID="tbSenha" runat="server" class="form-control form-control-lg senha" MaxLength="20" TextMode="Password" required="True"/>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2 form-group input-senha">
                        <span class="has-float-label mb-2 in-repsenha">
                            <label for="senhaRec" class="floatlabel color5">Repeta a senha</label>
                             <asp:TextBox ID="tbSenha2" runat="server" class="form-control form-control-lg senhaRec" MaxLength="20" TextMode="Password" required="True"/>
                            <img src="assets/image/eye.svg" alt="Visualizar" class="eye">
                        </span>
                    </div>
