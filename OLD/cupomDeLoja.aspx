<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="cupomDeLoja.aspx.vb" Inherits="Torra.cupomDeLoja" %>
<!DOCTYPE html>
<html lang="pt-BR">
<head runat="server">
...
<body class="padding-bottom pilot-project">
    ...
    <main role="main" class="login">
        <section class="top-banner vh-100 h-remove">
            <div class="container py-3 py-md-5 h-100 h-remove">
                <div class="row  h-100 h-remove">
                    <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 text-center h-100 h-remove flex-column d-flex justify-content-center align-items-center order-2 order-md-1 mt-3 mt-md-0">
                        <img src="../assets/image/Raspe_&_Ganhe_page.png" alt="Raspe & Ganhe" class="mb-4 mb-md-5 w-50 d-none d-sm-block">
                        <h4 class="text-orange">PROJETO PILOTO</h4>
                        <p class="text-white pb-3">Preencha os campos abaixo, experimente nossa raspadinha online e concorra a prêmios de até R$100,00 para usar em nosso <b>Site</b> e <b>APP</b>.</p>

                        <span class="has-float-label mb-3 in-cpf">
                            <label for="cpf" class="floatlabel color1">Informe seu CPF</label>
                            <asp:TextBox ID="tbCPF" runat="server" class="form-control form-control-lg cpf" type="text" name="cpf" placeholder="CPF"></asp:TextBox>
                        </span>
                        <span class="has-float-label mb-3 in-cpf">
                        ...
                        <asp:Button ID="butCadastrar" runat="server" Text="GERAR SUA RASPADINHA" class="btn btn-primary bt-save text-uppercase mt-3 btn-md"></asp:Button>
                    </div>
                    <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 h-100 h-250 order-1 order-md-2 text-center" >
                        <img src="../assets/image/Logo_Raspe&Ganhe.svg" alt="Raspe & Ganhe" class="w-50 d-flex d-sm-none m-auto">
                        <figure class="h-100 flex-column d-flex justify-content-center align-items-center">
                            <img src="../assets/image/raspe-ganhe-box-01.png" alt="Raspe & Ganhe" class="w-auto with-mobile">
        ...
        <section id="results" class="result-pp">
            <div class="container py-3 py-md-5">
                <div class="row no-gutters pb-5">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center flex-column d-flex justify-content-center align-items-center">
                        <h3 class="text-white font-weight-light pb-2">Você ganhou seu <strong class="text-orange font-weight-bold d-block d-md-inline">Raspe & Ganhe</strong></h3>
                        <p class="text-white pb-4">Utilize seu CPF para entrar no Raspe & Ganhe. Siga as instruções no <br class="d-none d-md-block">aplicativo para testar sua sorte nas raspadinhas 
                    </div>
                        ...
                        <div class="PaperImpress">
                            ...
                            <div class="paper py-3 py-md-4">
                                <div class="txt-paper" id="divQRCode" runat="server">
                                    ...
                                    <p class="m-0"><strong>Forma de Pagamento:</strong> Cartão Torra</p>
                                    <div class="row no-gutters pb-5 pt-3 pt-md-5 d-flex justify-content-center align-items-center">
                                        <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 pl-2 text-center">
                                            <img src="../assets/image/raspadinha-QRCode-Teste.png" class="w-100"/>
                                        </div>
                                        <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 text-left pl-3">
                                            <small>Escaneie o qrcode e acesse nosso APP para usar sua raspadinha</small>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center h-100  d-flex flex-row flex-sm-row flex-md-row  justify-content-center align-items-center pb-5">
