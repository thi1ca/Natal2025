<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/semMenu.Master" CodeBehind="index_newOption.aspx.vb" Inherits="Natal_torra.index_newOption" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="row no-gutters bt-cpf-incio">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-4">
                        <h3 class="text-white text-center">
                            <strong>Vamos começar?</strong><br>
                            Informe seu CPF e Celular para identificação</h3>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group mb-2">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 form-group pb-5">
