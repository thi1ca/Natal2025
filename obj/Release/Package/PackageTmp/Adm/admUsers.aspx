<%@ Page Title="Lojas Torra - Usuários" Language="vb" AutoEventWireup="false" MasterPageFile="~/Adm/admLogado.Master" CodeBehind="admUsers.aspx.vb" Inherits="Natal_torra.admUsers" %>
        ...
        <section  class="mb-3 mb-md-5">
            <div class="row mt-3 mt-md-5 align-items-center">
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-6 col-xl-6 text-right text-sm-right text-md-right text-lg-right text-xl-right fixed-mobile">
                    ...
                    <a class="btn bt-blue text-uppercase mr-0 mr-md-2 bt-mobile" href="perfil.html" role="button">+ Editar perfil</a>
                    <a class="btn bt-blue text-uppercase bt-mobile" href="admUsers_edit.aspx" role="button" >+ Criar Usuários</a>
                </div>
