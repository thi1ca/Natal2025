...
//   _.extend(RouletteWheel.prototype, Backbone.Events);
  ...
  RouletteWheel.prototype.render = function(){
    ...
    for(var i=0; i<count; i++){
      ...
      $item.find('.label').css({
        ...
        transform: 'translateY('+ (D*-.24) +'px) translateX('+  (textHeight*1.03) +'px) rotateZ('+ (90 + delta*.5) +'deg)',
  ...
  $(window).ready(function(){
    ...
    spinner.click('spin:start', function(r){ console.log('spin start!') });
    spinner.click('spin:end', function(r){ 
