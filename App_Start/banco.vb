...
#Region "Caminho"
    ...
    Public Shared Function caminhoTorra() As String
        'Dim ds As New DataSet
        'ds.ReadXml(ado.xml)
        Dim cam As String
        'cam = ds.Tables("sistema").Select("id='1'")(0).Item("banco")
        ...
        'cam = ".; initial catalog=fluxa; persist security info=False; user id=sa; password=wertyu"
        cam = "data source=172.16.103.81;"
        cam += "initial catalog=WS_Ecommerce;"
        cam += "persist security info=False;"
        cam += "user id=ServicesEcom;"
        cam += "password=&Comxpx936"
        Return cam
    End Function
...
#Region "Métodos Consulta"
    ...
    Public Shared Function consultaTorra(ByVal comando As String) As DataView
        Dim conexao As New SqlConnection(caminhoTorra)
        Dim comando1 As New SqlCommand("", conexao)
        Try
            comando1.CommandText = comando
            Dim da As New SqlDataAdapter(comando1)
